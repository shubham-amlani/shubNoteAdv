...
class ChatServer implements MessageComponentInterface {
    ...
    public function onMessage(ConnectionInterface $from, $msg) {
        ...
        // Use the same timestamp for both database storage and WebSocket broadcast
        $timestamp = date('Y-m-d H:i:s'); // UTC time for consistency
        ...
        $messageData = [
            'sender' => $senderId,
            'message' => $message,
            'timestamp' => $timestamp // Same timestamp being used
        ];
